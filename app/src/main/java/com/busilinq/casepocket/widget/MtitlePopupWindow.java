...
import com.busilinq.casepocket.adapter.PopAdapter;
...
public class MtitlePopupWindow extends PopupWindow {
     ...
     * ListView的数据源
     */
    private List<PopItem> list = new ArrayList<PopItem>();
    /**
     * PopupWindow的宽度
     */
    private int width = 0;
...
/*        setWidth(250);
        ...
        adapter = new PopAdapter(listView, list,R.layout.popupwindow_item);
     ...
     * @param mList
     */
    public void changeData(List<PopItem> mList) {
